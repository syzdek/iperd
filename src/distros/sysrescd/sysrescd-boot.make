...
$(CONFIGDIR)/sysrescd/sysrescd.pxe.cfg: Makefile $(DISTRODIR)/sysrescd/sysrescd.pxe.cfg
...
boot/sysrescd/sysrcd.md5: tmp/sysrescd-@VERSION@/sysrcd.dat
	@mkdir -p "$$(dirname "$(@)")"
	cp tmp/sysrescd-@VERSION@/sysrcd.md5 "$(@)"
	@test -f "$(@)" && touch "$(@)"
